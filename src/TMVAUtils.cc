...
namespace tmva
{
  ...
  {
    if (method=="Likelihood")    return new TH1D( method,  method + ";Likelihood ratio;Events", 25, 0, 2 );               
    if (method=="LikelihoodD")   return new TH1D( method,  method + ";Likelihood ratio;Events", 25, 0, 2 );
    if (method=="LikelihoodPCA") return new TH1D( method,  method + ";Likelihood ratio;Events", 25, 0, 2 );
    if (method=="LikelihoodKDE") return new TH1D( method,  method + ";Likelihood ratio;Events", 25, 0, 2 );
    if (method=="LikelihoodMIX") return new TH1D( method,  method + ";Likelihood ratio;Events", 25,  0, 2 );
