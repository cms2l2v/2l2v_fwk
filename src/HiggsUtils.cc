...
//      TH1D* lineshape = getHistoFromNRfile(TString("mH_SI_NR_nnlo")+pf, mass, Csecond, BRnew2, nrLineShapesFile);  // (signal + interference) * NNLOKFactors   
 ...
 double weightContinuum_MELA( bool isVBF, double CP, double heavyMass){
	...
	//Filling ContinuumWeights VBF
        cpWeight_MapVBF[100.0][200] = 0.0171810340377397397; 
        cpWeight_MapVBF[100.0][300] = 0.1956733624361671198;
        cpWeight_MapVBF[100.0][400] = 0.1010851647151301408;
        cpWeight_MapVBF[100.0][500] = 0.0521492540193889964;
        cpWeight_MapVBF[100.0][600] = 0.0365831878265270860;
        cpWeight_MapVBF[100.0][700] = 0.0267171357906592667;
        cpWeight_MapVBF[100.0][800] = 0.0244479690024275893;
        cpWeight_MapVBF[100.0][900] = 0.0121415158733263646;
        cpWeight_MapVBF[100.0][1000] = 0.0086556520818645566;
        cpWeight_MapVBF[100.0][1500] = 0.0029656950932476752;
        cpWeight_MapVBF[100.0][2000] = 0.0022959436210834264;
        cpWeight_MapVBF[100.0][2500] = 0.0018694877259789753;
        cpWeight_MapVBF[100.0][3000] = 0.0007487418991230966;

        cpWeight_MapVBF[10.0][200] = 0.0171810340377397397;
        cpWeight_MapVBF[10.0][300] = 0.1956733624361671198;
        cpWeight_MapVBF[10.0][400] = 0.1010851647151301408;
        cpWeight_MapVBF[10.0][500] = 0.0521492540193889964;
        cpWeight_MapVBF[10.0][600] = 0.0365831878265270860;
        cpWeight_MapVBF[10.0][700] = 0.0267171357906592667;
        cpWeight_MapVBF[10.0][800] = 0.0244479690024275893;
        cpWeight_MapVBF[10.0][900] = 0.0121415158733263646;
        cpWeight_MapVBF[10.0][1000] = 0.0086556520818645566;
        cpWeight_MapVBF[10.0][1500] = 0.0029656950932476752;
        cpWeight_MapVBF[10.0][2000] = 0.0022959436210834264;
        cpWeight_MapVBF[10.0][2500] = 0.0018694877259789753;
        cpWeight_MapVBF[10.0][3000] = 0.0007487418991230966;

        cpWeight_MapVBF[5.0][200] = 0.0171810340377397397;
        cpWeight_MapVBF[5.0][300] = 0.1956733624361671198;
        cpWeight_MapVBF[5.0][400] = 0.1010851647151301408;
        cpWeight_MapVBF[5.0][500] = 0.0521492540193889964;
        cpWeight_MapVBF[5.0][600] = 0.0365831878265270860;
        cpWeight_MapVBF[5.0][700] = 0.0267171357906592667;
        cpWeight_MapVBF[5.0][800] = 0.0244479690024275893;
        cpWeight_MapVBF[5.0][900] = 0.0121415158733263646;
        cpWeight_MapVBF[5.0][1000] = 0.0086556520818645566;
        cpWeight_MapVBF[5.0][1500] = 0.0029656950932476752;
        cpWeight_MapVBF[5.0][2000] = 0.0022959436210834264;
        cpWeight_MapVBF[5.0][2500] = 0.0018694877259789753;
        cpWeight_MapVBF[5.0][3000] = 0.0007487418991230966;
