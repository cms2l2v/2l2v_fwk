...
void ComputeContinuum_Weights(){
	...
	string FileCont = "plotter_2017_01_21_ContinuumWeight.root";
	string  FileSig = "plotter_2017_01_04_full2016_MCOnly.root"; //"plotter_2017_01_24_SignalOnly.root";
	string      Dir = "/user/amagitte/HZZ_2L2Nu_Analysis_2016/PreApproval_Moriond2017/CMSSW_8_0_20/src/UserCode/llvv_fwk/test/hzz2l2v/";
