...
if [ "${1}" = "submit" ]; then 
    ...
    ONLYLEPTAU=" --onlyStartWith singlemu_alteventflowslep --onlyStartWith singlee_alteventflowslep --onlyStartWith singlemu_step1njets --onlyStartWith singlee_step1njets "
