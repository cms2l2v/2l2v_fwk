...
# Fixed run 
    ...
    BASEDIR=/afs/cern.ch/work/v/vischia/private/code/tau_dilepton/chhiggs_5311_f/
    if [ "${2}" = "anal_sus" ]; then
	...
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_geq2btagssumpt_pdf.root --showUnc --plotExt .pdf --noPowers --onlyStartWith emu_geq2btagsmet.pdf
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_geq2btagssumpt_pdf.root --showUnc --plotExt .pdf --noPowers --onlyStartWith emu_geq2btagsnbjets.pdf
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_geq2btagssumpt_pdf.root --showUnc --plotExt .pdf --noPowers --onlyStartWith emu_geq2btagsptlep.pdf
	...
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_png.root --showUnc --plotExt .png --noPowers --onlyStartWith emu_evtflow
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_png.root --showUnc --plotExt .png --noPowers --onlyStartWith emu_geq2btagssumpt
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_png.root --showUnc --plotExt .png --noPowers --onlyStartWith emu_met
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_png.root --showUnc --plotExt .png --noPowers --onlyStartWith emu_mll
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_png.root --showUnc --plotExt .png --noPowers --onlyStartWith emu_mtsum
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_png.root --showUnc --plotExt .png --noPowers --onlyStartWith emu_nbjets
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_png.root --showUnc --plotExt .png --noPowers --onlyStartWith emu_njets
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_png.root --showUnc --plotExt .png --noPowers --onlyStartWith emu_nvertices
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_png.root --showUnc --plotExt .png --noPowers --onlyStartWith emu_nverticesUnweighted
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_png.root --showUnc --plotExt .png --noPowers --onlyStartWith emu_pte
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_png.root --showUnc --plotExt .png --noPowers --onlyStartWith emu_ptjet1eta
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_png.root --showUnc --plotExt .png --noPowers --onlyStartWith emu_ptjet1pt
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_png.root --showUnc --plotExt .png --noPowers --onlyStartWith emu_ptjet2eta
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_png.root --showUnc --plotExt .png --noPowers --onlyStartWith emu_ptjet2pt
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_png.root --showUnc --plotExt .png --noPowers --onlyStartWith emu_ptmin
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_png.root --showUnc --plotExt .png --noPowers --onlyStartWith emu_ptmu
	runPlotter --iLumi 19702 --inDir ${BASEDIR} --outDir ${BASEDIR}plots --json data/plot-ch-higgs_samples.json --outFile ${BASEDIR}plotter-forPlotting_png.root --showUnc --plotExt .png --noPowers --onlyStartWith emu_sumpt
