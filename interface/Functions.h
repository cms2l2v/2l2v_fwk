#ifndef _musclefitcorrector_func_h_
#define _musclefitcorrector_func_h_
...
inline scaleFunctionBase<double * > * scaleFunctionService( const int identifier ){
  switch ( identifier ) {
...
inline resolutionFunctionBase<double * > * resolutionFunctionService( const int identifier ){
  switch ( identifier ) {
