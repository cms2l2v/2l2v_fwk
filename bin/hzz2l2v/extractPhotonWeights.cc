...
// GRaph1
  ...
  TH1D *h_zmass_ee_3=readHist(cat+hcat[2]+var,dyfile,"data",1);
  ...
  cat="ee";  
  h_zmass_ee_1->Write(cat+hcat[0]+"_zmass");
  h_zmass_ee_2->Write(cat+hcat[1]+"_zmass");
  h_zmass_ee_3->Write(cat+hcat[2]+"_zmass");
  cat="mumu";  
